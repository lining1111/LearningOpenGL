...
auto basePath = string("chapter7/lightingADS/");

void init(GLFWwindow *window) {
    renderingProgram = Utils::createShaderProgram(string(basePath + "GouraudShaders/vertShader.glsl").c_str(),
                                                  string(basePath + "GouraudShaders/fragShader.glsl").c_str());
    cameraX = 0.0f;
    cameraY = 0.0f;
    cameraZ = 1.0f;
    torLocX = 0.0f;
