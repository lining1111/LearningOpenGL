...
auto basePath = string("chapter10/sphereVertexHeightMap/");
...
void init(GLFWwindow *window) {
    ...
    colorTexture = Utils::loadTexture(string(basePath + "earthspec1kBLUE.jpg").c_str());
    normalTexture = Utils::loadTexture(string(basePath + "earthspec1kNORMAL.jpg").c_str());
    heightTexture = Utils::loadTexture(string(basePath + "earthspec1kNEG.jpg").c_str());
}
...
int main(void) {
    ...
    GLFWwindow *window = glfwCreateWindow(800, 800, "Chapter 10 - program 4b", NULL, NULL);
