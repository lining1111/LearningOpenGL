...
auto basePath = string("chapter10/normalMapping/");
...
void init(GLFWwindow *window) {
    ...
    roofTexture = Utils::loadTexture(string(basePath + "castleroofNORMAL.jpg").c_str());
}
...
int main(void) {
    ...
    GLFWwindow *window = glfwCreateWindow(800, 800, "Chapter 10 - program 2", NULL, NULL);
