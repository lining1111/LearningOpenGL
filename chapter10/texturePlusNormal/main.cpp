...
auto basePath = string("chapter10/texturePlusNormal/");
...
void init(GLFWwindow *window) {
    ...
    moonTexture = Utils::loadTexture(string(basePath + "moon.jpg").c_str());
    moonNormalMap = Utils::loadTexture(string(basePath + "moonNORMAL.jpg").c_str());
}
