...
auto basePath = string("chapter16/singleRefraction/");
...
void init(GLFWwindow *window) {
    ...
    brickTexture = Utils::loadTexture(string(basePath + "brick1.jpg").c_str());
    earthTexture = Utils::loadTexture(string(basePath + "earthmap1k.jpg").c_str());
    xpTex = Utils::loadTexture(string(basePath + "cubeMap/xp.jpg").c_str());
    xnTex = Utils::loadTexture(string(basePath + "cubeMap/xn.jpg").c_str());
    ypTex = Utils::loadTexture(string(basePath + "cubeMap/yp.jpg").c_str());
    ynTex = Utils::loadTexture(string(basePath + "cubeMap/yn.jpg").c_str());
    zpTex = Utils::loadTexture(string(basePath + "cubeMap/zp.jpg").c_str());
    znTex = Utils::loadTexture(string(basePath + "cubeMap/zn.jpg").c_str());
}
...
int main(void) {
    ...
    GLFWwindow *window = glfwCreateWindow(windowWidth, windowHeight, "Program 16.10 - refractive sphere", NULL, NULL);
