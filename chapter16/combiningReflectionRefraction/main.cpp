...
auto basePath = string("chapter16/combiningReflectionRefraction/");
...
void init(GLFWwindow *window) {
    ...
    marbleTexture = Utils::loadTexture(string(basePath + "ice.jpg").c_str());
}
...
int main(void) {
    ...
    GLFWwindow *window = glfwCreateWindow(windowWidth, windowHeight, "Program 16.11 - reflection + refraction", NULL,
                                          NULL);
