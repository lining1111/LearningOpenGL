...
auto basePath = string("chapter13/geomModExplodeWithBackFaces/");

void init(GLFWwindow *window) {
    renderingProgram = Utils::createShaderProgram(string(basePath + "vertShader.glsl").c_str(),
                                                  string(basePath + "geomShader.glsl").c_str(),
...
#endif
    GLFWwindow *window = glfwCreateWindow(800, 800, "Chapter 13 - program 1c", NULL, NULL);
