...
auto basePath = string("chapter12/tessHeightMappedInstWLighting/");

void init(GLFWwindow *window) {
    renderingProgram = Utils::createShaderProgram(string(basePath + "vertShader.glsl").c_str(),
                                                  string(basePath + "tessCShader.glsl").c_str(),
                                                  string(basePath + "tessEShader.glsl").c_str(),
    ...
    squareMoonTexture = Utils::loadTexture(string(basePath + "squareMoonMap.jpg").c_str());
    squareMoonHeight = Utils::loadTexture(string(basePath + "squareMoonBump.jpg").c_str());
    squareMoonNormals = Utils::loadTexture(string(basePath + "squareMoonNormal.jpg").c_str());
...
#endif
    GLFWwindow *window = glfwCreateWindow(800, 800, "Chapter 12 - program 3b", NULL, NULL);
