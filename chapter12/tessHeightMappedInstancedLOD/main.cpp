...
auto basePath = string("chapter12/tessHeightMappedInstancedLOD/");
...
void display(GLFWwindow *window, double currentTime) {
    ...
    if (cameraZ > 0.9f) transDir = -1.0f;
    if (cameraZ < 0.3f) transDir = 1.0;
...
#endif
    GLFWwindow *window = glfwCreateWindow(800, 800, "Chapter 12 - program 4", NULL, NULL);
