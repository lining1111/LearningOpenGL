...
float rotAmt = 0.0f;
auto basePath = string("chapter17/distortionCorrection/");
...
void init(GLFWwindow *window) {
    ...
    distCorrectionProgram = Utils::createShaderProgram(string(basePath + "vertDistCorrShader.glsl").c_str(),
                                                       string(basePath + "fragDistCorrShader.glsl").c_str());
    cameraX = 0.0f;
    cameraY = 0.13f;
    cameraZ = 0.3f;
    gndLocX = 0.0f;
